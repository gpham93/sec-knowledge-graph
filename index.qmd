...
document.addEventListener("DOMContentLoaded", function() {
  ...
  function queryGemini(userMessage) {
    ...
    if (!apiKey) {
      appendMessage('bot', '⚠️ Please configure your Gemini API Key using the ⚙️ API Key button above (or get a free 1-click key at <a href="https://aistudio.google.com/app/apikey" target="_blank">Google AI Studio</a>).');
      return;
    }
